...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = "¿Sabes?\nUna vez escuché que puedes encontrar a alguien especial\nen los lugares más inesperados.\n\nSi me hubieran dicho\nque te conocería buscando trabajo,\nprobablemente me habría reído.\n\nPero ahí estabas,\nsin fuegos artificiales,\nsino con una calma que desarma.\n\nY sin buscarlo,\nencontré mucho más que empleo:\n\nTe encontré a ti.\n\nDesde entonces,\ncuando pienso en el futuro,\nno puedo no verte en él.";  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "TE AMO";
